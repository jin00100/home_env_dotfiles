...

{
  ...
  programs.zsh = {
    ...
    initContent = ''
      ...
      # ---------------------------------------------------------
    if [[ -n "$TMUX" ]]; then
        # 아스키 아트 본체 (역슬래시 수정 필요 없음)
        cat << 'EOF'
  ___    ___ ________  ________   ________  _____ ______   ___  ________   ________  ________  ___     
 |\  \  /  /|\   __  \|\   ___  \|\   ____\|\   _ \  _   \|\  \|\   ___  \|\   __  \|\   __  \|\  \    
 \ \  \/  / | \  \|\  \ \  \\ \  \ \  \___|\ \  \\\__\ \  \ \  \ \  \\ \  \ \  \|\  \ \  \|\  \ \  \   
  \ \    / / \ \  \\\  \ \  \\ \  \ \  \  __\ \  \\|__| \  \ \  \ \  \\ \  \ \   __  \ \   _  _\ \  \  
   \/  /  /   \ \  \\\  \ \  \\ \  \ \  \|\  \ \  \    \ \  \ \  \ \  \\ \  \ \  \ \  \ \  \\  \\ \  \ 
 __/  / /      \ \_______\ \__\\ \__\ \_______\ \__\    \ \__\ \__\ \__\\ \__\ \__\ \__\ \__\\ _\\ \__\
|\___/ /        \|_______|\|__| \|__|\|_______|\|__|     \|__|\|__|\|__| \|__|\|__|\|__|\|__|\|__|\|__|
\|___|/                                                                                                
EOF
